...
$plugin_slug = "review-widgets-for-bookatable/review-widgets-for-bookatable.php";
...
$plugin_updated = ($trustindex_pm_bookatable->get_plugin_current_version() <= "6.8.1");
?>
<div class="ti-box">
...
<?php
$dir = __DIR__ . '/../review-widgets-for-bookatable.php';
...
Options: <?php foreach ($trustindex_pm_bookatable->get_option_names() as $opt_name) {
if($opt_name == "css-content")
{
continue;
}
$option = get_option($trustindex_pm_bookatable->get_option_name( $opt_name ));
echo "\n\t". esc_html($opt_name) .": ";
...
CSS: <?php echo esc_html(get_option($trustindex_pm_bookatable->get_option_name('css-content'))) ."\n\n"; ?>
Active Theme: <?php
