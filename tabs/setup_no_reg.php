...
<li class="<?php echo !$trustindex_pm_bookatable->is_noreg_linked() ? "active" : "done"; ?><?php if($current_step == 1): ?> current<?php endif; ?>" href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=setup_no_reg&step=1">
<span>1</span>
<?php echo TrustindexPlugin::___('Connect %s platform', [ 'Bookatable' ]); ?>
</li>
<span class="ti-free-arrow"></span>
<li class="<?php echo $style_id ? "done" : ($trustindex_pm_bookatable->is_noreg_linked() ? "active" : ""); ?><?php if($current_step == 2): ?> current<?php endif; ?>" href="?page=<?php echo esc_attr($_GET['page']); ?>&tab=setup_no_reg&step=2">
<span>2</span>
...
<?php if($trustindex_pm_bookatable->is_trustindex_connected() && in_array($selected_tab, [ 'setup_no_reg', 'my_reviews' ])): ?>
...
{
$reviews = $wpdb->get_results('SELECT * FROM '. $trustindex_pm_bookatable->get_noreg_tablename() .' ORDER BY date DESC');
}
?>
<?php if($current_step == 1 || !$trustindex_pm_bookatable->is_noreg_linked()): ?>
<h1 class="ti-free-title">
1. <?php echo TrustindexPlugin::___('Connect %s platform', [ 'Bookatable' ]); ?>
</h1>
<?php if($trustindex_pm_bookatable->is_noreg_linked()): ?>
<?php $page_details = get_option($trustindex_pm_bookatable->get_option_name('page-details')); ?>
...
<?php endif; ?>
<a href="<?php echo esc_url($trustindex_pm_bookatable->getPageUrl()); ?>" target="_blank"><?php echo esc_url($trustindex_pm_bookatable->getPageUrl()); ?></a>
</div>
...
<?php else: ?>
<div class="ti-box">
<form method="post" action="" data-platform="bookatable" id="submit-form">
<input type="hidden" name="command" value="save-page" />
<?php wp_nonce_field( 'save-noreg_'.$trustindex_pm_bookatable->get_plugin_slug(), '_wpnonce_save' ); ?>
<input type="hidden"
name="page_details"
class="form-control"
required="required"
...
<?php endif; ?>
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin::___('See a %s Widget example below:', [ 'Bookatable reviews' ]); ?></div>
<div class="ti-preview-box">
<?php echo $trustindex_pm_bookatable->get_trustindex_widget('ae8d632691b427ede4d367d43'); ?>
</div>
</div>
...
<div class="notice notice-warning" style="margin: 0 0 15px 0">
<p>
<?php echo TrustindexPlugin::___('There are no reviews on your %s platform.', [ 'Bookatable' ]); ?>
</p>
</div>
<?php else: ?>
...
<div class="preview">
<?php echo $trustindex_pm_bookatable->get_noreg_list_reviews(null, true, $id, 'light-background', true); ?>
</div>
</div>
</div>
<?php endforeach; ?>
...
<div class="preview">
<?php echo $trustindex_pm_bookatable->get_noreg_list_reviews(null, true, $style_id, $id, true); ?>
</div>
</div>
</div>
<?php endforeach; ?>
...
<div class="preview">
<div id="ti-review-list"><?php echo $trustindex_pm_bookatable->get_noreg_list_reviews(null, true); ?></div>
...
<div class="ti-select" id="show-star" data-platform="bookatable">
<font></font>
<ul>
...
<?php wp_nonce_field( 'save-language_'.$trustindex_pm_bookatable->get_plugin_slug(), '_wpnonce_language' ); ?>
...
<?php wp_nonce_field( 'save-dateformat_'.$trustindex_pm_bookatable->get_plugin_slug(), '_wpnonce_dateformat' ); ?>
...
<?php wp_nonce_field( 'save-options_'.$trustindex_pm_bookatable->get_plugin_slug(), '_wpnonce_options' ); ?>
...
<?php if(!$trustindex_pm_bookatable->is_ten_scale_rating_platform()): ?>
<span class="ti-checkbox row">
...
<code class="code-shortcode">[<?php echo $trustindex_pm_bookatable->get_shortcode_name(); ?> no-registration=bookatable]</code>
...
<a class="btn-text" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-bookatable-1" target="_blank"><?php echo TrustindexPlugin::___('Create a Free Account for More Features'); ?></a>
<div class="notice notice-success ti-special-offer">
<img src="<?php echo $trustindex_pm_bookatable->get_plugin_file_url('static/img/special_30.jpg'); ?>">
...
<li>
<strong><?php echo TrustindexPlugin::___("%d Review Platforms", [ $trustindex_pm_bookatable->get_platform_count() ]); ?></strong><br />
...
<img src="<?php echo $trustindex_pm_bookatable->get_plugin_file_url('static/img/platforms.png'); ?>" alt="" style="margin-top: 5px" />
</li>
<li>
...
<a class="btn-text" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-bookatable-2" target="_blank"><?php echo TrustindexPlugin::___('Create a Free Account for More Features'); ?></a>
</div>
<?php endif; ?>
<?php endif; ?>