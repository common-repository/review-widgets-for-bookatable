...
$chosed_platform = new TrustindexPlugin($force_platform, $file_path, "do-not-care-6.8.1", "do-not-care-Widgets for Bookatable Reviews", "do-not-care-Bookatable");
